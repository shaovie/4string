var settings = {
	...
	upload_url: "http://4string.cn/uploadimg.php",
	post_params: {
		"PHPSESSID" : "NONE",
		"HELLO-WORLD" : "Here I Am",
		".what" : "OKAY"
	},
	file_size_limit : "150MB",
...
SWFUpload.onload = function() {
    ...
    if(currAction.indexOf('/admin/Event/addPage')>0
      ||currAction.indexOf('/admin/Event/editPage')>0  
    ) {
     	var swfu2 = new SWFUpload(settings2);
    }
    if(currAction.indexOf('/admin/Video/addPage')>0
      || currAction.indexOf('/admin/Video/editPage')>0
    ) {
        var swfu2 = new SWFUpload(settings2);
...
function preview($filePath, file) {
	...
	//商品缩略图
		...
		$('#prev_event_img ul').append("<li style='display:inline;'><img src='" + imgPath + "' style='width:100px;height:120px;margin-right:2px;' /><a onclick='delGoodsImg(this);return false;' href='javascript:void(0)'>删除</a></li>");
		$('#event_img').append('<input type="hidden" name="event_img[]" value="'+imgPath+'">');
