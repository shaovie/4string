...
<body align="center">
    <div style="margin: 0 0 0 0">
        ...
        <div id="right" style="margin: 64 65 0 0">
            <a href="/m/Home/event"><img id="ui_camera" border="0" src="/asset/images/ui_camera.png" style="display:none"></a>
        </div>
        <div id="footer"></div>
...
<body align="center">
<?php foreach($eventList as $idx => $event):?> <!-- 事件列表 -->
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <?php foreach($event['video_url'] as $j => $videourl):?>
           <div class="swiper-slide">
                <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="833" height="473" poster="<?php echo $event['image_url'][$j]?>" data-setup="{}">
                <source src="<?php echo $event['video_url'][$j]?>" type="video/mp4">
